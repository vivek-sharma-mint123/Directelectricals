package com.directelectricals.webautomation.config;
...
public class Constants {
	...
	static {
		...
		try {
			...
			String configFilePath =  userDir + "/src/main/java/com/directelectricals/webautomation/config/" + configFileName; 	
